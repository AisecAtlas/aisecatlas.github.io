...
2011년 설립됐고, 단일 경량 에이전트 위에 기능을 모듈처럼 얹어가는 구조가 핵심 차별점입니다. 새 기능을 추가해도 에이전트를 다시 설치하지 않습니다.
...
2024년 7월 콘텐츠 업데이트 결함으로 글로벌 규모의 시스템 장애가 발생했습니다. 이후 운영과 배포 정책이 어떻게 바뀌었는지는 도입 검토 시 별도로 확인합니다.
...
- [Devices 영역](/pillars/devices/) — 엔드포인트 통제 지점과 솔루션 분포
- [CrowdStrike 벤더 프로필](/ai/vendors/crowdstrike/) — 회사별 AI 보안 상세
