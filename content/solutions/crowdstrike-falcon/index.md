...
**데이터 리전.** 글로벌입니다. 한국 데이터 리전은 별도로 확인해야 합니다.

**정부 클라우드 인증.** CSAP 인증 현황은 정기적으로 확인해야 합니다.

**망분리 환경.** 내부망 분리 환경에선 일부 기능이 제한됩니다.
...
본 평가는 공개 자료를 근거로 합니다. 2024년 7월 글로벌 장애 이후 운영 정책이 변할 수 있으니 도입 전에 최신 백서를 확인하세요. 절대 평가이지 상대 평가가 아닙니다.
