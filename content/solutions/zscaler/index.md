...
규모도 근거가 된다. FY2025 4분기에 연간반복매출(ARR)이 **30억 달러**를 넘었고 매출은 전년 대비 **21% 증가**했다([SEC 8-K](https://www.sec.gov/Archives/edgar/data/0001713683/000171368325000138/zs-07312025_991.htm)). FY2026 1분기 매출은 **26% 증가**했다([SEC 8-K](https://www.sec.gov/Archives/edgar/data/0001713683/000171368325000203/zs-10312025_991.htm)).

기존 VPN은 사용자를 사내 네트워크에 들여보낸다. Zscaler는 네트워크를 사용자에게 확장하지 않고, 개별 디바이스와 개별 앱 사이에만 일대일 연결(**segment of one**)을 만든다. 앱은 외부에 노출되지 않고 안에서 밖으로 연결을 맺는다.
...
**망분리.** 클라우드 SaaS형 인라인 보안 플랫폼. 한국 공공과 금융의 망분리 환경 적용 가능성은 별도 검토가 필요하며, 이번 검토에서 국내 적용 사례는 확인하지 못했다.
