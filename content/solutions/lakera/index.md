...
Lakera는 LLM 런타임 가드레일 전문 업체로, 2025년 10월 Check Point가 인수를 완료했습니다([Check Point](https://www.checkpoint.com/press-releases/check-point-acquires-lakera-to-deliver-end-to-end-ai-security-for-enterprises/)). 인수 금액은 SEC 6-K 기준 순현금 약 **1억 8,700만 달러**입니다([SEC 6-K](https://www.checkpoint.com/downloads/investor/6k-december-2-2025.pdf)). 2차 매체가 추정한 3억 달러는 공식 수치와 다릅니다. 취리히 본사는 Check Point의 AI 보안 센터 기반이 됩니다.
...
- [Applications 영역](/pillars/applications/) — Lakera가 속한 솔루션 카탈로그 영역
- [Check Point 벤더 프로필](/ai/vendors/check-point/) — Lakera를 인수한 모회사 정리
- [LLM 게이트웨이](/ai/llm-gateway/) — LLM 런타임 통제 시장 비교
...
- [Check Point SEC 6-K (인수액 순현금 약 1억 8,700만 달러)](https://www.checkpoint.com/downloads/investor/6k-december-2-2025.pdf)
