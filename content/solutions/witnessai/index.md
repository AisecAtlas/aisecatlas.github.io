...
차별점은 **의도 분류**입니다. WitnessAI는 에이전트의 행동이 프롬프트의 의도와 일치하는지 검사하는 의도 분류(intention classification) 모델을 둡니다. 단순 입출력 차단을 넘어 에이전트의 일탈 행동을 봅니다.
...
- [WitnessAI 벤더 프로필](/ai/vendors/witnessai/) — 회사와 제품 라인 상세
