...
규모도 근거가 된다. FY2025(2025년 1월 종료) 구독 ARR **10억 9,260만 달러**(전년 대비 **39% 증가**), 매출 **2억 5,810만 달러**(**47% 증가**), 10만 달러 이상 구독 고객 **2,246곳**이다([Rubrik IR](https://ir.rubrik.com/news-events/press-releases/news-details/2025/Rubrik-Reports-Fourth-Quarter-and-Fiscal-Year-2025-Financial-Results/default.aspx)).
...
**망분리.** 한국 공공과 금융의 망분리 환경에서는 백업 관리 서버 위치와 통신 방식 검토가 필요하며, 이번 검토에서 국내 적용 사례는 확인하지 못했다.
