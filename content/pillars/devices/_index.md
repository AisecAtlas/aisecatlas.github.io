...
> **자산 인벤토리, 신뢰 평가, 정책 적용**이 핵심입니다. EDR과 XDR이 가장 큰 카테고리입니다.
...
| 카테고리 | 대표 솔루션 |
|---|---|
| EPP / EDR | CrowdStrike Falcon, SentinelOne, Microsoft Defender for Endpoint |
| XDR | Palo Alto Cortex XDR, Trellix, Trend Vision One |
