...
> **5개 영역으로 솔루션을 분류합니다.** 각 영역 카드는 카테고리 설명과 개별 솔루션 리뷰로 연결됩니다. CISA Zero Trust Maturity Model 기준입니다.
...
<div class="card-desc">5개 영역에 걸쳐 작동합니다. Visibility (SIEM/XDR), Automation, Governance.</div>
...
가로축은 CISA ZTMM 성숙도 단계, 세로축은 보안 영역입니다. 단계는 일직선이 아닙니다. 영역마다 단계가 달라도 됩니다.
...
모든 솔루션 리뷰는 같은 구조를 따릅니다. 한눈에 보기, 어떤 제품인가, 시장 위치, 강점과 한계, 언제 선택하나, 도입 고려사항으로 정리합니다.

각 리뷰는 CISA ZTMM 영역과 NIST SP 800-207 7원칙을 기준으로 솔루션의 위치를 짚습니다.
