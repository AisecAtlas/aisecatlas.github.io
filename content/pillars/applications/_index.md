...
> **개발, 배포, 런타임을 잇는 전 주기 보안이 핵심입니다.** 경계가 아니라 워크로드 단위로 보호하며, AI/LLM 보안도 이 영역에 포함됩니다.
...
AI, LLM 보안은 별도로 깊이 다룹니다. [AI를 지키는 일](/ai/defend-ai/)과 [AI-SPM 솔루션](/ai/ai-spm/)을 참고하세요.

## 시장 동향 (2025-2026)

**사상 최대 인수.** Google은 클라우드 보안 기업 Wiz를 **320억 달러** 전액 현금에 인수했습니다. 2025년 3월 18일 발표 후 2026년 3월 11일 완료된, 사이버보안 역사상 최대 규모 인수입니다([TechCrunch](https://techcrunch.com/2026/03/11/google-completes-32b-acquisition-of-wiz/)). Wiz는 2025년 연간 반복 매출 **10억 달러**를 넘겼습니다([TechCrunch](https://techcrunch.com/2026/03/11/google-completes-32b-acquisition-of-wiz/)).
...
**개인정보보호법.** 클라우드 구성 오류로 인한 데이터 노출은 개인정보 유출 사고로 직결됩니다. CSPM의 민감 데이터 노출 탐지 범위를 확인하세요.

**망분리와 N²SF.** [국가망보안체계(N²SF)](/korea/regulation/n2sf-mangbunri/) 전환으로 공공 클라우드 활용이 늘면, 워크로드 단위 보호와 가시성을 제공하는 CNAPP의 역할이 커집니다.

**공공과 정부.** 클라우드형 CNAPP은 [CSAP 인증](/korea/regulation/csap-n2sf/)과 데이터 처리 리전을 확인해야 합니다.
