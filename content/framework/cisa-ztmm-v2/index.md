...
ZTMM은 행정명령 [EO 14028](https://www.federalregister.gov/documents/2021/05/17/2021-10460/improving-the-nations-cybersecurity)과 [OMB M-22-09](https://www.whitehouse.gov/wp-content/uploads/2022/01/M-22-09.pdf)를 근거로 미국 연방기관에 사실상 의무화돼 있습니다.
...
> **v1 → v2 변경.** v2.0(2023.4)은 v1의 3단계에 **Initial** 단계를 추가해 4단계가 됐고, Identity에 **Access Management** function을 분리 신설했으며 세 횡단 기능을 전 Pillar에 명시했습니다. ([CISA v2 릴리스 공지](https://www.cisa.gov/news-events/news/cisa-releases-updated-zero-trust-maturity-model))
...
조직 전체가 같은 단계일 필요는 없습니다. 영역마다 다른 단계여도 됩니다(Pillar별 비대칭 성숙 허용, [CISA ZTMM v2 PDF](https://www.cisa.gov/sites/default/files/2023-04/CISA_Zero_Trust_Maturity_Model_Version_2_508c.pdf)).

## Pillar별 단계 요약

아래 기술 키워드(ITDR, SASE/SSE, DSPM 등)는 CISA 단계 서술을 현행 시장 기술로 의역한 것이며 CISA 원문 문구가 아닙니다.
...
CISA 원문은 Pillar마다 function 개수가 다르고 "function 25개"라는 용어를 쓰지 않습니다. 세 횡단 기능(Visibility & Analytics, Automation & Orchestration, Governance)은 각 Pillar 안에서 function으로 반복 등장합니다. 본 사이트는 솔루션을 Pillar와 Function으로 분류하기 위해 Pillar당 대표 function 5개를 선정해 25개 격자로 재구성했습니다. 아래 명칭은 본 사이트 기준이며 CISA 원문 명칭과 1:1로 일치하지 않을 수 있습니다.
...
DoD RA의 152 Activity는 7 Pillar 기반의 별도 세부 분류이며, CISA ZTMM의 function 구조와 직접 1:1로 대응하지 않습니다.

## 규제 적용

CISA ZTMM은 미국 연방기관 환경을 가정합니다. 한국 조직에 적용할 때는 다음을 함께 봅니다.

**망분리 환경.** ZTMM의 전 구간 암호화와 통합 가시성 가정이 한국 망분리 정책과 충돌할 수 있습니다. [한국 노트의 망분리 페이지](/korea/regulation/)를 참고합니다.
...
- [솔루션 가이드](/pillars/)의 5 영역 구분은 ZTMM의 5 Pillar 구조를 따릅니다.
