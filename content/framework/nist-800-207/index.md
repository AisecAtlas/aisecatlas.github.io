...
본 사이트의 [평가 척도 B축](/evaluation/scoring-rubric/)은 이 7원칙을 기반으로 한다.

## 핵심 컴포넌트

Zero Trust는 다음 세 컴포넌트의 협업으로 작동한다.
...
K-ZTA 같은 공식 가이드는 아직 NIST 표준을 그대로 채택하는 형태가 아니다. 망분리, 전자금융 규제와의 정합성을 함께 짚어야 한다. 자세한 내용은 [한국 노트의 규제 페이지](/korea/regulation/)와 연결한다.
