...
NIST가 발표한 **AI 위험 관리 거버넌스 프레임워크**입니다. 자발적 가이드이며, AI 위험을 식별, 평가, 관리하는 4대 기능으로 구성합니다.
...
NIST는 2024년 7월 **Generative AI Profile**(AI 600-1)을 발표했습니다. AI RMF 1.0의 첫 분야 횡단(cross-sectoral) 프로파일이자 동반 문서로, 생성형 AI에 고유하거나 악화되는 **위험 12개 범주**를 정의하고 4대 기능에 매핑된 권고 행동을 제시합니다.
...
> **GOVERN이 중심입니다.** 나머지 세 기능을 떠받치는 교차 기능으로, 거버넌스 없이는 MAP, MEASURE, MANAGE가 일회성에 그칩니다.

각 기능은 다시 다수의 **카테고리, 서브카테고리**로 세분됩니다(예: GOVERN은 6개 카테고리). 카테고리별 권장 행동은 [AI RMF Playbook](https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook)에 정리되어 있습니다. 본 페이지는 4대 기능 수준만 다룹니다.

## Trustworthy AI 7대 특성

AI RMF는 신뢰할 수 있는 AI의 특성 7가지를 기준으로 위험을 봅니다.
...
원문은 1번 유효성과 신뢰성을 나머지 특성의 **기반 특성**으로 두고, 그 위에 안전, 보안, 책임 등을 쌓는 위계로 봅니다.
...
**규제와의 관계.** NIST AI RMF는 자발적 가이드라 한국의 법적 의무와는 별개입니다. 국내 AI 신뢰성 정책과 AI 기본법(인공지능 발전과 신뢰 기반 조성 등에 관한 기본법) 흐름에 매핑해 참고합니다. 국내 법령 원문과 시행 일정은 별도 1차 출처로 확인합니다.

**개인정보보호법.** Trustworthy AI의 프라이버시 강화와 보안 특성은 개인정보보호법, 정보보호 체계와 직접 연결됩니다.
