...
NIST는 2024년 7월 **Generative AI Profile**(AI 600-1)을 발표했다. AI RMF 1.0의 첫 분야 횡단(cross-sectoral) 프로파일이자 동반 문서로, 생성형 AI에 고유하거나 악화되는 **위험 12개 범주**를 정의하고 4대 기능에 매핑된 권고 행동을 제시한다.
...
각 기능은 다시 다수의 **카테고리, 서브카테고리**로 세분된다(예: GOVERN은 6개 카테고리). 카테고리별 권장 행동은 [AI RMF Playbook](https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook)에 정리되어 있다. 본 페이지는 4대 기능 수준만 다룬다.
...
원문은 1번 유효성과 신뢰성을 나머지 특성의 **기반 특성**으로 두고, 그 위에 안전, 보안, 책임 등을 쌓는 위계로 본다.
...
**규제와의 관계.** NIST AI RMF는 자발적 가이드라 한국의 법적 의무와는 별개다. 국내 AI 신뢰성 정책과 AI 기본법(인공지능 발전과 신뢰 기반 조성 등에 관한 기본법) 흐름에 매핑해 참고한다. 국내 법령 원문과 시행 일정은 별도 1차 출처로 확인한다.
