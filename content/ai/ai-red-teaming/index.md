...
2025년 11월 v5.1.0 기준 **16개 전술, 84개 기법, 56개 하위 기법, 32개 완화책, 42개 실제 사례**를 담습니다([Practical DevSecOps](https://www.practical-devsecops.com/mitre-atlas-framework-guide-securing-ai-systems/)). 2025년 10월 업데이트에서 Zenity Labs 협업으로 **에이전트 전용 기법 14개**가 추가됐습니다. 무료 도구인 ATLAS Navigator와 Arsenal로 위협 모델링이 가능합니다.
