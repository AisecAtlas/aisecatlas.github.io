...
> **이 페이지의 결론**: AI 거버넌스, 또는 AI TRiSM은 개별 공격을 막는 기술 도구가 아니라 조직이 AI를 어떻게 쓰고 통제하는지 정하는 정책, 위험, 컴플라이언스 계층이다. [런타임 가드레일](/ai/llm-gateway/), [레드티밍](/ai/ai-red-teaming/), [AI-SPM](/ai/ai-spm/) 위에서 이들을 묶는 우산이다. EU AI Act, NIST AI RMF, ISO 42001이 기준이다.

## AI 거버넌스란

AI 거버넌스는 AI 자산 인벤토리, 정책 집행, 위험 관리, 감사 가능한 증거 생성을 다룬다([Credo AI](https://www.credo.ai/product)). Gartner는 이 시장을 AI TRiSM(Trust, Risk and Security Management)으로 부르며, 2025년 AI 거버넌스 플랫폼 시장 가이드를 발간했다([Credo AI 블로그](https://www.credo.ai/blog/credo-ai-recognized-in-the-gartner-r-market-guide-for-ai-governance-platforms-2025)).

## 기술 계층과의 관계

거버넌스는 기술 방어를 대체하지 않는다. 그 위에서 조직 정책으로 묶는다.
...
대부분의 글로벌 기업은 세 가지를 동시에 적용받는다([EC-Council 비교](https://www.eccouncil.org/cybersecurity-exchange/responsible-ai-governance/eu-ai-act-nist-ai-rmf-and-iso-iec-42001-a-plain-english-comparison/)).
...
다만 2026년 5월 7일 EU 이사회와 의회가 Digital Omnibus에 잠정 합의해 고위험 시스템 적용 시점을 뒤로 미루는 방향이 논의되고 있다([gaicc 비교](https://gaicc.org/blog/ai-governance-comparison-eu-ai-act-nist-iso-42001/)). 최종 확정 전까지 일정은 유동적이다.
...
Holistic AI는 2026년 Guardian Agents를 출시해 지속 관찰(Sentinel)과 실시간 개입(Operative) 에이전트를 더했다([Modulos 정리](https://www.modulos.ai/best-ai-governance-platforms/)).

## 도입 의사결정 가이드

### 어디서부터 시작하나

**1단계: 인벤토리.** 조직이 쓰는 AI 시스템과 모델을 목록화한다. 섀도 AI 발견은 [AI-SPM](/ai/ai-spm/)과 겹친다.

**2단계: 위험 분류.** EU AI Act 기준으로 고위험 여부를 판단하고 NIST AI RMF로 위험을 평가한다.

**3단계: 정책과 증거.** ISO 42001 관리 체계로 정책을 문서화하고 감사 증거를 생성한다.
...
**자동화된 결정 대응권.** [개인정보보호법](/korea/regulation/pipa-zero-trust-data/)의 자동화된 결정 대응권(제37조의2)은 AI 거버넌스의 핵심 요건이다. 설명 요구와 거부권을 처리 절차에 반영해야 한다.

**생성형 AI 처리 안내서.** 개인정보보호위원회의 생성형 AI 처리 안내서가 AI 수명주기 단계별 거버넌스 기준을 제시한다. 거버넌스 도구의 정책 템플릿과 연계한다.

**글로벌 동시 적용.** EU 사업이 있는 한국 기업은 EU AI Act와 국내 개인정보보호법을 동시에 충족해야 한다. 프레임워크 매핑 기능이 있는 도구가 부담을 줄인다.
