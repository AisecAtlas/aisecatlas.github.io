...
> **AI 보안은 세 축입니다.** ① 사내 LLM과 에이전트를 **지키고**, ② 직원이 쓰는 AI를 **가시화하고 통제**하고, ③ AI로 SOC 운영을 **강화**합니다. 세 축은 위협도 시장도 따로 움직입니다.

14개 벤더를 한 장으로 보려면 [AI 보안 지도](/ai/map/), 회사별 상세는 [벤더 프로필](/ai/vendors/)입니다.
...
한국 규제 변수는 [표준과 규제](/framework/)가 정리합니다.
