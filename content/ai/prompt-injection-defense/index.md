...
프롬프트 인젝션은 [OWASP LLM Top 10](/framework/owasp-llm-top-10/)의 1위 위험(LLM01)입니다. 입출력 필터만으로는 막지 못하며, 신뢰 경계 격리와 도구 호출 정책을 더한 심층 방어가 필요합니다. 2026년의 핵심 난제는 에이전트를 노리는 간접 인젝션입니다.
