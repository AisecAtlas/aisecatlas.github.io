...
> **이 페이지의 결론**: **AI-SPM(AI Security Posture Management)**은 조직이 쓰는 AI 자산을 발견하고, 그 구성과 권한의 위험을 평가하는 태세 관리 도구입니다. [AI를 지키는 일](/ai/defend-ai/)의 런타임 가드레일이 "실행 중 입출력을 막는다"면, AI-SPM은 "배포 전과 구성 단계에서 위험을 본다"는 점에서 보완 관계입니다. CNAPP 벤더들이 빠르게 이 영역으로 들어옵니다.
