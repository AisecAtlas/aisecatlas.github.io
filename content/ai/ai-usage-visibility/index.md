...
- **어디를 보려는가.** 우리가 만든 **승인 AI**(사내 LLM 앱, Copilot, Bedrock)는 클라우드 API나 게이트웨이로 봅니다. 직원이 쓰는 **미승인 AI**(웹 ChatGPT, DeepSeek)는 네트워크나 엔드포인트로 잡습니다. 승인 자산 인벤토리는 [AI-SPM](/ai/ai-spm/)이 담당합니다. 이 페이지는 **미승인 Shadow AI**가 주제입니다.
