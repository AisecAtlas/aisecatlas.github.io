...
딥페이크 영상과 음성 복제로 사람을 속이는 사기는 공격자가 AI를 무기로 쓰는 경우입니다. [AI를 지키는 일](/ai/defend-ai/)이 자사가 쓰는 AI 시스템을 보호하는 쪽이라면, 딥페이크 방어는 그 반대편, AI를 악용한 사칭에 대응하는 쪽입니다. 기술 탐지와 프로세스 통제를 함께 써야 막습니다.
