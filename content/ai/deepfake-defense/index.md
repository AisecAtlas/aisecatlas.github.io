...
> **이 페이지의 결론**: [AI를 지키는 일](/ai/defend-ai/)이 우리가 쓰는 AI 시스템을 보호하는 것이라면, 이 페이지는 반대편입니다. 공격자가 AI를 무기로 쓰는 경우, 즉 딥페이크 영상과 음성 복제로 사람을 속이는 사기를 다룹니다. 기술 탐지와 프로세스 통제를 함께 써야 막습니다.
