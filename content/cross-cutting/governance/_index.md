...
**컴플라이언스 자동화의 성장.** Vanta는 2025년 7월 1억 5천만 달러 시리즈 D를 **41억 5천만 달러** 기업가치에 유치했습니다([Vanta 공식](https://www.vanta.com/resources/vanta-announces-series-d)). 연간 반복 매출은 2026년 4월 기준 약 **3억 달러**(전년 대비 69% 증가)로 추정됩니다([Sacra 추정](https://sacra.com/c/vanta/)). Drata는 2025년 2월 ARR **1억 달러** 달성을 공식 발표했고(설립 3.5년), 같은 해 SafeBase를 인수했습니다([Drata](https://drata.com/blog/announcing-fy25-momentum)).
...
- [AI 거버넌스](/ai/ai-governance/) — AI 시스템과 모델을 다루는 별도 거버넌스 축
- [NIST AI RMF](/framework/nist-ai-rmf/) — AI 위험 관리 프레임워크 한국어 요약
