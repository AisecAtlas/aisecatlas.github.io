...
**벤더 생태계.** Microsoft Security Store에 70개 이상의 파트너 에이전트가 등록됐고, CrowdStrike는 Charlotte AgentWorks를 공개했습니다. 자세한 내용은 [Security Copilots 비교](/automation/security-copilots/)를 참고합니다.
...
**금융권.** 자율 대응 범위는 금감원 보안성 심의에서 면밀히 검토됩니다. 감사 추적과 인간 승인 흐름을 처음부터 설계합니다.
